...
type GrowingTextarea_forReplyProps = {
...
const GrowingTextarea_forReply = forwardRef<HTMLTextAreaElement, GrowingTextarea_forReplyProps>(
  ({ initialLiked, className, wrapperClassName, placeholder, value, onChange }, ref) => {
    return (
      <div
        className={cn(
          wrapperClassName,
...
GrowingTextarea_forReply.displayName = "GrowingTextarea_forReply";

export default GrowingTextarea_forReply;
